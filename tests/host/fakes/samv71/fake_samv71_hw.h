...
#define US_IER_USART_RXRDY_Msk (UINT32_C(1) << 0)
#define US_IER_USART_OVRE_Msk (UINT32_C(1) << 5)
#define US_IER_USART_FRAME_Msk (UINT32_C(1) << 6)
#define US_IER_USART_PARE_Msk (UINT32_C(1) << 7)
