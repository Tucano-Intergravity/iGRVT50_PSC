...
add_executable(sam_ctl_default_image_ronqZXHz ${sam_ctl_default_library_list})

set_target_properties(sam_ctl_default_image_ronqZXHz PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${sam_ctl_default_output_dir}")
target_link_libraries(sam_ctl_default_image_ronqZXHz PRIVATE ${sam_ctl_default_default_XC32_FILE_TYPE_link})

# Add the link options from the rule file.
sam_ctl_default_link_rule( sam_ctl_default_image_ronqZXHz)
...
add_dependencies(sam_ctl_default_Bin2Hex sam_ctl_default_image_ronqZXHz)
